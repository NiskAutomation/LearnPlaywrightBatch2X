...
//Take a number and print weather it is even or odd
let number = 7;
if (number % 2 === 0) {
...
//take marks  and 0 to 100 and print the grade based on these rules:
// 90 and above: A
// 80 -> 89: B
// 70 -> 79: C
// 60 -> 69: D
...
//Given the percentage of the testcases passed in CI build, report build health as follows:
//100% => Green Build
//90% - 99% => stable(Investigate Failures)
//70% - 89% => Unstable (Investigate Failures)
//below 70% => Broken Build (blocker release)
...
if (percentagePassed === 100) {
    ...
    console.log("Unstable (Investigate Failures)");
} else if (percentagePassed < 70) {
    console.log("Broken Build (blocker release)");
} else {
    console.log("Invalid percentage");
}


//track failed login attempts, lock the account after 3 failed attempts, and print appropriate messages
let failedLoginAttempts = 3;
